	...
	<div class="gray_box">
		...
		<div class="tab_a">
			<ul>
				...
				<li><a class="active" href="/successContract?providerId=3">
						<div class="img">
						...
						<div class="info">
							<div class="thumb">
								<a href="/channel?influencerId=${contract.influencerId}"><img
									...
									<a href="/contractDocument/?contractId=${contract.id }&state=success" class="note"><img src="static/images/ico_note.png" alt=""></a>
							</div>
							<div class="desc">
